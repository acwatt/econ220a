...
% Below are alternative algorithms for the quasi-newton method.
%options = optimoptions(@fminunc,'Algorithm','quasi-newton');  
%options = optimoptions(@fminunc,'Algorithm','trust-regiontrust-region');
...
%fminunc (option quasi Newton’s Method, derivitive-based)
[theta2,fval,exitflag,output] = fminunc('gmmobjg',theta2,options)

% fminsearch uses a simplex method, random walk on a convex polytope.
